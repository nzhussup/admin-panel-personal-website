    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                ...
                .route("base-service", r -> r.path("/api/v1/base/**")
                        .filters(f -> f.rewritePath("/api/v1/base/(?<segment>.*)", "/v1/base/${segment}"))
                        .uri("lb://base-service"))
                ...
                .route("user-service", r -> r.path("/api/v1/user/**")
                        .filters(f -> f.rewritePath("/api/v1/user/(?<segment>.*)", "/v1/user/${segment}"))
                        .uri("lb://user-service"))
                ...
                // IMAGE SERVICE
                .route("image-service", r -> r.path("/api/v1/album/**")
